...
exports.foundItemCategoriesController = void 0;
const http_status_codes_1 = __importDefault(require("http-status-codes"));
const catchAsync_1 = __importDefault(require("../../../shared/catchAsync"));
const sendResponse_1 = __importDefault(require("../../../shared/sendResponse"));
const Found_item_categories_service_1 = require("./Found-item-categories.service");
const foundItemCategories = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const category = yield Found_item_categories_service_1.FoundItemCategoryService.createFoundItemCategory(req.body);
